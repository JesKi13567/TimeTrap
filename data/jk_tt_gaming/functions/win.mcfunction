...
title @a subtitle ""
advancement grant @a only jk_tt_gaming:clock/win
advancement grant @a[advancements={jk_tt_gaming:clock/learn=false}] only jk_tt_gaming:clock/winner
playsound music_disc.pigstep player @a 0 -1000000 0 72000 1
scoreboard players set #author jk_tt_mem 0
schedule function jk_tt_gaming:author 8s replace
