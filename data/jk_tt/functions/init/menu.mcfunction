...
execute unless score #lang jk_tt_mem matches 1 run tellraw @a ["我是占位：",{"text":"[如何游玩]","color":"yellow","clickEvent":{"action":"run_command","value":"/execute as @a run function jk_tt:init/help"}},"  ",{"text":"[开始游戏]","color":"light_purple","hoverEvent":{"action":"show_text","value":"开始游戏时所有玩家传送到你的位置。"},"clickEvent":{"action":"run_command","value":"/function jk_tt:play/start"}},"  ",{"text":"[lang]","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"切换为English","color":"green"}},"clickEvent":{"action":"run_command","value":"/function jk_tt:init/settings/lang"}}]
execute if score #lang jk_tt_mem matches 1 run tellraw @a ["Blankspace: ",{"text":"[How to Play]","color":"yellow","clickEvent":{"action":"run_command","value":"/execute as @a run function jk_tt:init/help"}},"  ",{"text":"[Start!]","color":"light_purple","hoverEvent":{"action":"show_text","value":"All the players will teleport to you."},"clickEvent":{"action":"run_command","value":"/function jk_tt:play/start"}},"  ",{"text":"[lang]","color":"gold","hoverEvent":{"action":"show_text","contents":{"text":"Switch to 中文","color":"green"}},"clickEvent":{"action":"run_command","value":"/function jk_tt:init/settings/lang"}}]

# 载入设置
# load the settings
function jk_tt:init/settings