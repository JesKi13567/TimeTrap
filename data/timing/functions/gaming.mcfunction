...
# 时间流逝
execute if score #game_on mem matches 1.. if score #public mem matches 0 as @a[tag=on_game,gamemode=!spectator] at @s run function timing:count
execute if score #game_on mem matches 1.. if score #public mem matches 1 run function timing:count_public
