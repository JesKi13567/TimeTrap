...
scoreboard objectives add jk_tt_death_limit dummy "jk_tt_死亡剩余次数"
scoreboard objectives add jk_tt_time_limit dummy "jk_tt_剩余时间"
...
scoreboard objectives add jk_tt_team_trigger trigger "jk_tt_队伍触发"
